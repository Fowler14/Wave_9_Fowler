...
const tasks = ["Go to the Gym", "Meal prep lunches", "Study letPhil"];
console.log(tasks)
...
console.log(`This was the task removed --> ${removedTask}`)
...
console.log("Kept Tasks: ", longTasks)
...
const totalCharacters = tasks.reduce((total, task) => {
